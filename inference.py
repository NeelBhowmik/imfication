...
# Example : perform live image classification in image/video/webcam using
# CNN models.
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="class names - accept below formats:"
            ...
            " 2. class name textfile containing: 1-class name in a line" ) 
    parser.add_argument(
        "--conf_thrs",
        type=float,
        default=0.3,
...
def main():
    ...
    if args.image:
        ...
        for im in lst_img:
            ...
            img_shape = im_cv.shape
            resized_cam_img = cv2.resize(cam_img, (img_shape[1], img_shape[0]))
            combine_img = cv2.hconcat([im_cv, resized_cam_img])
